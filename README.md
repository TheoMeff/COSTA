...
|UI_TITLE|COSTA| Chat title (left-top) and page title (HTML)
|UI_LOGO|| Logo (left-top). Defaults to COSTA logo. Configure the URL to your logo image to modify.
|UI_CHAT_LOGO|| Logo (chat window). Defaults to COSTA logo. Configure the URL to your logo image to modify.
...
|UI_FAVICON|| Defaults to COSTA favicon. Configure the URL to your favicon to modify.
